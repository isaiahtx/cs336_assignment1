...
from src.assignment1 import TransformerLM, cross_entropy, data_loading, save_checkpoint, load_checkpoint
from src.assignment1.optimizers import AdamW, learning_rate_schedule, gradient_clipping
...
def run_multihead_self_attention(
    ...
    """
    cmha = CausalMHA(d_model,num_heads)
